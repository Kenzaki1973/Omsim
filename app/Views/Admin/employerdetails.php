            ...
            <div class="card card-primary">
              ...
              <div class="card-footer">
                <?php if ($viewEmp['status'] != 'Approved'): ?>
                            <a href="<?= site_url('employer_approved/') . $viewEmp['emp_id'] ?>" class="btn btn-success">Accept</a>
                        <?php endif; ?>
                        <?php if ($viewEmp['status'] != 'Approved'): ?>
                            <a href="<?= site_url('employer_decline/') . $viewEmp['emp_id'] ?>" class="btn btn-danger">Decline</a>
                        <?php endif; ?>
              </div>
            </div>
            <!-- /.card -->
